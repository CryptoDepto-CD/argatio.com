  ...
  return (
    <div className="py-4 my-auto">
      ...
      <div className="flex flex-wrap items-center gap-8 justify-evenly font-montserrat text-clamp-text">
        <div className="*:mb-2">
          <p className="font-medium uppercase">Total adquirido</p>
        ...
        <div className="*:mb-2">
          <p className="font-medium uppercase">Bloqueado</p>
          <p className="flex gap-5">
      ...
      <div className="w-full mt-5 flex justify-end">
        <div className="w-full md:w-1/2">
          ...
          <button className="px-10 py-1 uppercase min-w-fit grow w-full rounded-full bg-[#545454] opacity-80 hover:cursor-not-allowed" disabled>Liberar</button>
        </div>
      </div>
