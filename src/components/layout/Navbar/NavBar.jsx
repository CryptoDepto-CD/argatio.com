    ...
    return (
        <nav className="relative flex items-center justify-between px-12 py-4 uppercase">
            ...
            <ul className={`fixed md:static bg-zinc-950 md:bg-transparent px-20 md:px-0 w-full md:w-auto md:flex top-0 left-0 h-full md:h-auto pt-20 md:pt-0 items-center justify-center ${isOpen ? 'block' : 'hidden'} md:flex z-20 *:md:text-center`}>
                ...
                <li className={`mr-2 md:mt-0 mt-3 text-white text-xs lg:text-sm font-montserrat hover:drop-shadow-[0px_1px_4px_white] transition-colors`}><Link href="/tokenomics">ARGA Token</Link></li>
                <li className={`mr-2 md:mt-0 mt-3 text-white text-xs lg:text-sm font-montserrat hover:drop-shadow-[0px_1px_4px_white] transition-colors`}><Link href="/vesting">Preventa</Link></li>
                ...
                <li className={`mr-2 md:mt-0 mt-12 text-white text-xs lg:text-sm font-montserrat hover:drop-shadow-[0px_1px_4px_white] transition-colors`}><Link href="/wallet">Iniciar Sesión</Link></li>
